...
import { HomepageTrustpilotReviewsCarousel } from "@/components/homepage-trustpilot-reviews-carousel";
    ...
    <div className="min-h-screen bg-[#F8FAFC] text-[#111827]">
      ...
      <main>
        ...
        <VehicleCategoryCardsBlock
          title="Compare Car Rental Prices Worldwide"
          subtitle="Compare popular vehicle categories, explore rental options, and continue to the Top7Spots car rental page to search live deals."
          label="TRAVEL PARTNER"
          variant="full"
          className="py-12"
          affiliateLinkLabel="Compare rental cars on DiscoverCars.com"
          footerCtaLabel="Compare Car Rental Prices"
          headerCtaLabel={null}
        />
        ...
        {travelerReviews.length > 0 ? (
          <section id="traveler-reviews" className="border-y border-slate-200 bg-white py-16">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <HomepageTrustpilotReviewsCarousel reviews={travelerReviews} />
            </div>
          </section>
        ) : null}
